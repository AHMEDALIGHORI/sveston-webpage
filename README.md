...
<img src="public/assets/photo/readme-banner.png" alt="Franck Muller Vanguard Smurfette" width="100%" />

<br/>

<!-- ANIMATED TYPING EFFECT -->
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Playfair+Display&weight=400&size=32&pause=1000&color=F7A1C6&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=80&lines=Where+Playful+Heritage+Meets;High-Complication+Horology" alt="Typing SVG" /></a>

<br/>

<!-- BADGE ROW -->
<img src="https://img.shields.io/badge/Limited_Edition-88_Pieces-f7a1c6?style=for-the-badge&labelColor=0b0b0b" alt="Limited Edition" />
&nbsp;
<img src="https://img.shields.io/badge/Swiss_Made-Geneva-d4af7a?style=for-the-badge&labelColor=0b0b0b" alt="Swiss Made" />
&nbsp;
<img src="https://img.shields.io/badge/Est.-1991-5bb3e4?style=for-the-badge&labelColor=0b0b0b" alt="Est. 1991" />
...
<!-- REPO STATS -->
<img src="https://img.shields.io/github/license/AHMEDALIGHORI/sveston-webpage?style=flat-square&color=f7a1c6&labelColor=1a1a1a" alt="License" />
<img src="https://img.shields.io/github/stars/AHMEDALIGHORI/sveston-webpage?style=flat-square&color=d4af7a&labelColor=1a1a1a" alt="Stars" />
<img src="https://img.shields.io/github/forks/AHMEDALIGHORI/sveston-webpage?style=flat-square&color=5bb3e4&labelColor=1a1a1a" alt="Forks" />
<img src="https://img.shields.io/github/last-commit/AHMEDALIGHORI/sveston-webpage?style=flat-square&color=999&labelColor=1a1a1a" alt="Last Commit" />
...
<table>
<tr>
<td align="center"><img src="https://via.placeholder.com/60x60/f7a1c6/f7a1c6?text=+" alt="Primary Pink" /><br/><b>Primary</b><br/><code>#f7a1c6</code></td>
<td align="center"><img src="https://via.placeholder.com/60x60/d4af7a/d4af7a?text=+" alt="Accent Gold" /><br/><b>Gold</b><br/><code>#d4af7a</code></td>
<td align="center"><img src="https://via.placeholder.com/60x60/5bb3e4/5bb3e4?text=+" alt="Accent Blue" /><br/><b>Blue</b><br/><code>#5bb3e4</code></td>
<td align="center"><img src="https://via.placeholder.com/60x60/0b0b0b/0b0b0b?text=+" alt="Background" /><br/><b>Background</b><br/><code>#0b0b0b</code></td>
<td align="center"><img src="https://via.placeholder.com/60x60/ffffff/ffffff?text=+" alt="Text" /><br/><b>Text</b><br/><code>#ffffff</code></td>
<td align="center"><img src="https://via.placeholder.com/60x60/050505/050505?text=+" alt="Footer" /><br/><b>Footer</b><br/><code>#050505</code></td>
</tr>
</table>
...
```mermaid
graph TB
    subgraph Frontend["🖥️ Frontend (Single Page)"]
        HTML["index.html<br/><i>Semantic HTML5</i>"]
        CSS["style.css<br/><i>CSS Custom Properties</i>"]
        JS["main.js<br/><i>Vanilla ES Modules</i>"]
    end

    subgraph Animations["🎬 Animation Layer"]
        GSAP["GSAP 3.12<br/><i>Timeline & ScrollTrigger</i>"]
        LENIS["Lenis 1.3<br/><i>Smooth Scroll</i>"]
        CANVAS["Canvas API<br/><i>Frame Sequence</i>"]
    end

    subgraph Sections["📑 Page Sections"]
        HERO["Hero<br/><i>Sticky + Video</i>"]
        PRODUCT["Product Reveal<br/><i>Parallax + Rotate</i>"]
        HERITAGE["Heritage<br/><i>Stagger Entrance</i>"]
        COLLECTION["Collection<br/><i>Variant Switcher</i>"]
        CRAFT["Craftsmanship<br/><i>152-Frame Canvas</i>"]
        SHOWCASE["Showcase<br/><i>Full-Bleed Image</i>"]
    end

    subgraph Deploy["🚀 Deployment"]
        VITE["Vite 6<br/><i>Build Tool</i>"]
        NETLIFY["Netlify<br/><i>CDN + Forms</i>"]
    end
    ...
    style Frontend fill:#1a1a2e,stroke:#f7a1c6,color:#fff
    style Animations fill:#1a1a2e,stroke:#d4af7a,color:#fff
    style Sections fill:#1a1a2e,stroke:#5bb3e4,color:#fff
    style Deploy fill:#1a1a2e,stroke:#88CE02,color:#fff
```
...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=300&size=14&pause=2000&color=D4AF7A&center=true&vCenter=true&repeat=true&width=500&height=30&lines=Crafted+with+precision.+Powered+by+obsession." alt="Footer Typing" /></a>
